      ...
      <main className={page.main}>
        ...
        <article className={page.article}>
          ...
          <p>
            ...
            eius possimus hic eligendi distinctio rerum incidunt, esse quasi eum
            molestiae ducimus ipsam quae, aliquid ullam placeat dolorum nulla
            vero. Quam? Lorem ipsum dolor sit, amet consectetur adipisicing
            elit. Sapiente repellat consequatur culpa, repudiandae aut dolores
            iusto. Rem natus soluta, dolores, ad deleniti, aut dolorem corrupti
            quasi amet unde delectus hic?
          </p>
          <br />
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Debitis
            ...
            molestiae ducimus ipsam quae, aliquid ullam placeat dolorum nulla
            vero. Quam? Lorem ipsum dolor sit amet consectetur, adipisicing
            elit. Vero quod necessitatibus, aspernatur pariatur asperiores earum
            quas adipisci veritatis quidem facilis! Nihil veniam quaerat nulla
          ...
          <p>
            ...
            necessitatibus tempora quod inventore corporis rem nihil itaque, at
            provident minus aliquam veritatis. Labore?
          </p>
          <br />
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Debitis
          ...
          <div className={page.btn_container}>
            <button
              style={{ padding: '1.5rem', marginLeft: 0 }}
              className={page.like_btn}
            >
              <RiThumbUpLine />
            </button>
            <button
              style={{ padding: '1.5rem', marginLeft: '1rem' }}
              className={page.share_btn}
            >
              <RiShareForwardLine />
            </button>
            <button
        ...
        <div className={page.user_articles}>
          <div className={page.user_articles_profile}>
            <h3>
              Latest articles by 
              <Link href={'anshulanand02'} className={page.user_link}>anshulanand02</Link>
            </h3>
          </div>
